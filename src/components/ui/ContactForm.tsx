...
import { FaUser, FaEnvelope, FaBriefcase, FaPaperPlane, FaChevronDown } from "react-icons/fa";
        ...
        >
            ...
            <motion.div variants={fadeInUp} className="relative z-50">
                ...
                <div ref={dropdownRef} className="relative">
                    ...
                    <div className="absolute right-4 top-1/2 -translate-y-1/2 pointer-events-none">
                        ...
                        >
                            <FaChevronDown
                                className={`w-3.5 h-3.5 transition-colors duration-300 ${isDropdownOpen ? "text-[#c8f560]" : "text-neutral-500"
                                    }`}
                            />
                        </motion.div>
                    </div>
                    ...
                    <AnimatePresence>
                        {isDropdownOpen && (
                            ...
                            >
                                {serviceOptions.filter(opt => opt.value !== "").map((option) => (
                                    <button
                                        key={option.value}
                                        type="button"
            ...
            <motion.div variants={fadeInUp} className="z-10 relative mt-15">
                <motion.button
                    ...
                    whileTap={{ scale: 0.98 }}
                    className="group relative overflow-hidden bg-[#c8f560] text-neutral-900 font-bold py-4 px-8 rounded-full transition-all duration-300 flex items-center gap-3"
                >
                    ...
                    {/* Button content */}
                    <span className="relative uppercase tracking-wider">Envoyer</span>
